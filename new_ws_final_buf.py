...
class AxiomTracker:
    ...
    def _output_token_info(self, data, processing_time, source, twitter_stats=None, migrated=None,
        ...
        # Проверяем, не является ли это постом
        ...
        # Twitter статистика (только если не пост и twitter_stats не None)
        ...
        print(f"⏱️  Processing:     {processing_time:.3f}s ({processing_time * 1000:.2f}ms)")
        print("=" * 80 + "\n")
